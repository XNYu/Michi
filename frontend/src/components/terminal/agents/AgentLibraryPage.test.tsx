...
const run = (definitionId: string): AgentRunDtoV1 => ({ version: 1, id: `run-${definitionId}`, ownerUserId: 'owner', workspaceId: 'workspace-1', definitionId, definitionRevision: 1, effectiveDefinition: { version: 1, name: 'Reviewer', description: 'Reviews.', instructions: 'Review.', runtimeProfile: { version: 1, runtimeId: 'claude' }, fallbackChain: [], capabilitySnapshot: { version: 1, entries: [] }, permissionPolicy, contextPolicy }, invocationMode: AgentRunInvocationMode.Manual, completionMode: AgentRunCompletionMode.Detach, parentRunId: null, parentNodeId: null, parentTurnId: null, parentMessageId: null, parentToolCallId: null, task: 'Review', contextManifest: { version: 1, entries: [], assembledAt: 1, estimatedChars: 0 }, expectedResult: null, executionEnvironment: { version: 1, kind: 'shared_workspace', cwd: '/tmp', sourceWorkspaceId: 'workspace-1', snapshotHash: hash, createdAt: 1 }, status: AgentRunStatus.Running, waitingReason: null, activeAttemptId: 'attempt', resultBundle: null, latestEventSeq: -1, createdAt: 1, startedAt: 1, completedAt: null, archivedAt: null, expiresAt: null });
